...
<p>	%{float:right}<img src="http://cataclysmicrewind.com/vizalign/examples/coordinatePlane.png"/>%
	...
	%{float:right}!http://cataclysmicrewind.com/vizalign/examples/coordinatePlane.png!%
