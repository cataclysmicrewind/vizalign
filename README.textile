...
h2. powerful api:
	...
	once you understand the four primary objects in VizAlign alignment will be easy. each code statement below builds upon the previous, so if you are not sure what the variable referenced is, look up.
	...
	each alignment needs two things: an aligner and a targetCoordinateSpace. alignments therefore, can : alignment.align(targetRectangle:Array);
	...
	@var results:Array = VizAlign.align ([new DisplayObject()], [alignment], ignoreOrigins, applyResults, pixelHinting);@
