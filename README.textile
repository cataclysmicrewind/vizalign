...
h2. powerful api:
	...
	@var results:Array = VizAlign.align ([new DisplayObject()], [alignment]); //has 3 more Boolean params@
...
* *natural api*: i want to align these _[targets]_ to the _[left of the stage]_.
