...
h2. powerful api:
	...
	the first thing to learn is that each alignment will need the objects you want to move and a stationary object to move the targets in relation to. 
	then, understand the four primary objects in VizAlign and alignment will be easy.
...
h6. this will look really wrong! download the src, it contains this example file so compile and smile! because i was right, this looks wrong.
