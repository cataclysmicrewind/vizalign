...
h6. this will look really wrong! copy this code and compile it to see for yourself. this is not a bug, but a missing feature that will never get implemented. for more information view the wiki page on this problem (soon)
...
package {
	public class Main {
		public function Main():void {
			...
			var brownGuy:RectangleSprite = new RectangleSprite(110, 110,  10,  50, 0x623131);
			addChild(greenGuy);
