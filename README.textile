...
h2. powerful api:  
	...
	@Aligners:@ aligns Rectangle. they need a targetCoordinateSpace (thing that doesn't move) and targets (things that do move).
	...
	@var alignment:VizAlignment = new VizAlignment(new CenterAligner(), stage);
	...
	@var results:Array = VizAlign.align ([logo], [alignment], ignoreOrigins, applyResults, pixelHinting);@

bq.	@ignoreOrigins:@ if true, VizAlign will treat each target as if 0,0 for it is at the top left of the graphics.
