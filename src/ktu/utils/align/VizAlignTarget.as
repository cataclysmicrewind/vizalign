	...
	*/
	public class VizAlignTarget extends Object {
		...
		*/
		 ...
		 */
		public function VizAlignTarget ( target:DisplayObject, uid:int = 0 ) :void {
			_target = target;
		 ...
		 * 
		 */
		public function clone ( target:DisplayObject = null ) :AlignObject {
			var ao:AlignObject = new AlignObject ((target) ? target : _target, _uid);
			ao.orig.x = _orig.x;
			ao.orig.y = _orig.y;
